...
namespace Assets.Scripts
{
    ...
    {
        public const string ROOM_WIDTH = "Room Width";
        public const string ROOM_HEIGHT = "Room Height";
        public const string WALL_THICKNESS = "Wall Thickness";
        ...
        public const string REQUIRES_AUTHENTICATION = "Requires Authentication";
