...
{
    public partial class WallCreator : MonoBehaviour
    {
                    ...
                    if ((i == 0 || i == WallDetails.height - 1) || (j == 0 || j == WallDetails.width - 1))
                    {
                        ...
                        for (int m = 0; m < WallDetails.wallsPerGrid; m++)
                        {
                            for (int n = 0; n < WallDetails.wallsPerGrid; n++)
                            {
                                ...
                                wallArr[i, j][m, n] = Instantiate(wallObject,
                                    new Vector3(WallDetails.wallThickness * i + m * WallDetails.wallSize,
                                        WallDetails.wallThickness * j + n * WallDetails.wallSize, 0),
