...
{
    public partial class ThermalManager : IThermalManager
    {
        public const float AbsoluteZero = -273.15f;

        private float _thermalPixelSize = 1f;
        ...
        public float GetTemperature(Vector3 position, TemperatureUnit temperatureUnit)
        {
